...
一个基于 Spring Boot、Spring Security、Vue3、Element Plus 的前后端分离的博客网站！本项目基本上是小格子一个人开发，由于工作和个人能力原因，部分技术都是边学习边开发，特别是前端（工作中是后端开发），基本上不熟悉，代码质量和设计，请大家多多指教（毕竟都 2023 年了，还被领导当面说月薪只值 3500 的人，哈哈哈）。
