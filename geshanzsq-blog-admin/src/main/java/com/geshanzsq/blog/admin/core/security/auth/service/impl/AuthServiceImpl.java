...
import com.geshanzsq.blog.admin.core.captcha.constant.CaptchaConstant;
import com.geshanzsq.blog.admin.core.security.auth.dto.AuthLoginDTO;
import com.geshanzsq.blog.admin.core.security.auth.service.AuthService;
import com.geshanzsq.blog.admin.core.security.auth.vo.AuthLoginVO;
...
import com.geshanzsq.blog.common.framework.manager.AsyncManager;
import com.geshanzsq.blog.common.redis.service.RedisService;
import com.geshanzsq.blog.framework.security.domain.LoginUserDetail;
import com.geshanzsq.blog.framework.security.service.TokenService;
import com.geshanzsq.blog.system.log.login.enums.LogLoginStatus;
import com.geshanzsq.blog.system.log.login.factory.LogLoginAsyncFactory;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthLoginVO login(AuthLoginDTO authLoginDTO) {
        ...
        // 异步记录登录日志
        AsyncManager.me().execute(LogLoginAsyncFactory.add(username, LogLoginStatus.SUCCESS.code,
