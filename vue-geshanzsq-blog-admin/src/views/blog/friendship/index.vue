<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-permission="['blog:friendship:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-permission="['blog:friendship:update']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-permission="['blog:friendship:delete']"
          >删除</el-button
        >
      </el-col>
    </el-row>
    ...
    >
      ...
      <el-table-column label="网站编号" prop="id" width="180" align="center" />
      <el-table-column
        label="网站名称"
        prop="linkName"
...
import Edit from './components/FriendshipEdit'

import { page, remove } from '@/api/blog/friendship'
...
async function handleDelete(row) {
  ...
  proxy.$modal
    .confirm('是否确认删除友情链接编号为【' + deleteIds + '】的数据项?')
    .then(async function () {
      await remove(deleteIds)
      proxy.$modal.msgSuccess('删除友情链接成功')
      handleQuery()
    })
}
