<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="标签编号" prop="id" width="180" align="center" />
      <el-table-column
        label="标签名称"
        prop="tagName"
...
import Edit from './components/TagEdit'

import { page, remove } from '@/api/blog/tag'
