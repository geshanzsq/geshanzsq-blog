package com.geshanzsq.blog.system.menu.service.impl;
...
import com.geshanzsq.blog.common.core.enums.YesNo;
...
import com.geshanzsq.blog.common.core.util.string.StrUtils;
...
import com.geshanzsq.blog.framework.security.utils.SecurityUtils;
...
import com.geshanzsq.blog.system.api.service.SysApiService;
import com.geshanzsq.blog.system.menu.constant.MenuConstant;
import com.geshanzsq.blog.system.menu.dto.SysMenuAuthApiDTO;
import com.geshanzsq.blog.system.menu.dto.SysMenuListDTO;
import com.geshanzsq.blog.system.menu.enums.MenuShowStatus;
import com.geshanzsq.blog.system.menu.enums.MenuStatus;
import com.geshanzsq.blog.system.menu.enums.MenuType;
import com.geshanzsq.blog.system.menu.mapper.SysMenuMapper;
import com.geshanzsq.blog.system.menu.mapstruct.SysMenuConverter;
...
import com.geshanzsq.blog.system.user.vo.MetaVO;
...
public class SysMenuServiceImpl extends BaseServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public List<RouterVO> getRouters() {
        ...
        if (loginUser.isHasSuperAdmin()) {
            ...
            menuVos = sysMenuMapper.getMenuByUserId(loginUser.getUserId(), CommonStatus.NORMAL.code,
                    CommonStatus.NORMAL.code, menuTypes);
        }
    ...
    public Integer getMaxSortByParentId(Long parentId) {
        return sysMenuMapper.getMaxSortByParentId(parentId == null ? 0 : parentId);
    }
     ...
     * @return 路由列表
     */
    private List<RouterVO> buildRouters(List<SysMenuVO> menus) {
    ...
    public String getRouteName(SysMenuVO menu) {
        String routerName = StrUtils.capitalize(menu.getRouterUrl());
        // 非外链并且是一级目录（类型为目录）
        if (isMenuFrame(menu)) {
